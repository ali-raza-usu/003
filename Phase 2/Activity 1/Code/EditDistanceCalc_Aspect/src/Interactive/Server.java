                 ...
                 {                          
                     ...
                     { 
             			...
             			if (key.isReadable()) {     
         				   ...
         				   TranslationResponseMessage msg_resp = new TranslationResponseMessage("Levenshtein Distance between string : " + msg.getData1() + " and string "+ msg.getData2() + " is "+ result);
             				buffer.clear();
             				buffer = ByteBuffer.wrap(Encoder.encode(msg_resp));                           
    		        		client.send(buffer, destAddr);            		
    		        		_logger.debug("Sending " + msg_resp.getResponse());
