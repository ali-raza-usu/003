...
public class KMClient {//implements {//Runnable {
	...
	public void getSharedKey(String name, String password) throws IOException
	{
		...
		System.out.println(_keyRequest.getName() + " : connecting to the server ");
		connectToServer();
		System.out.println(_keyRequest.getName() + " : sending message to the server ");
		...
		System.out.println(_keyRequest.getName() + " : received the key " + key.getSharedKey());
		closeConnections();
